/*
 *The following program is used for enrolling a finger print in the sensor
 *sending the enrollment details to the firebase which is later used for reterving and identifiying the person
 *developed by v.vamsi , k prudhvi
 */
...
#define FIREBASE_AUTH "***************************" // you can find it in the security settings
#define WIFI_SSID "your wifi name"  //wifi id
#define WIFI_PASSWORD "wifi password" // enter the wifi password
